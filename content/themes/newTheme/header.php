...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?php echo \Engine\core\Template\Theme::getUrl() ?>/img/contact-bg.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h3><?php echo Setting::get('name_site'); ?> </h3>
                        <hr class="small">
